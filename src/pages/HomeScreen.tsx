      ...
      <>
        <div id="container">
            ...
            <div id="HOME-CARDS" style={{width: "100%", height: "35%", display: "flex", flexDirection: "row", justifyContent: "center", gap: "12.5%", marginBottom: "10%"}}>
                <Card_button width={20} height={100} link="/QuizScreen" bgcolor="FDE4CF" text="Quizes" img_source={"../images/QuizCardImage.png"}  />
                <Card_button width={20} height={100} link="/ExamScreen" bgcolor="B4FFFB" text="Simulados" img_source={""}  />
                <Card_button width={20} height={100} link="/QuestionScreen" bgcolor="D9F2E6" text="Perguntas" img_source={""}  />
          ...
          <div id="HOME-USER-OPTIONS" className="User-Options">
                  <Card_button width={25} height={80} link="/UserScreen" bgcolor="FFF3CD" text="Settings" img_source={""}  />
